...
Command compose-build-attempt-1 failed with exit code 1; likely failure family: docker-networking (67% rule confidence).

## Run identity

- Run: `local-20260628T084018Z-4bbba968-046d57`
- Environment: `local`
...
- Exit code: `1`
- Duration: `462590.688 ms`
- [Command log](commands/build/compose-build-attempt-1/command.log)
...
1. Pipeline stage `build` invoked `compose-build-attempt-1`.
2. The command exited `1` after `462590.688 ms`.
...
- Open or build a Honeycomb query filtered by observability.run_id = local-20260628T084018Z-4bbba968-046d57.
