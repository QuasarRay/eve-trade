...
Command compose-build-attempt-3 failed with exit code 1; likely failure family: docker-networking (67% rule confidence).

## Run identity

- Run: `local-20260628T151319Z-ec4710ad-2a76b8`
- Environment: `local`
- Git SHA: `ec4710ad643cf582d73904bbff823c276ccac7be`
...
- Exit code: `1`
- Duration: `210831.029 ms`
- [Command log](commands/build/compose-build-attempt-3/command.log)
...
1. Pipeline stage `build` invoked `compose-build-attempt-3`.
2. The command exited `1` after `210831.029 ms`.
...
- Open or build a Honeycomb query filtered by observability.run_id = local-20260628T151319Z-ec4710ad-2a76b8.
...
- [compose.yaml](https://github.com/QuasarRay/eve-trade/blob/ec4710ad643cf582d73904bbff823c276ccac7be/compose.yaml)
- [docker-compose.integration.yml](https://github.com/QuasarRay/eve-trade/blob/ec4710ad643cf582d73904bbff823c276ccac7be/docker-compose.integration.yml)
- [distributed-backend/src/api-gateway/distributed-backend/quilkin_udp.go](https://github.com/QuasarRay/eve-trade/blob/ec4710ad643cf582d73904bbff823c276ccac7be/distributed-backend/src/api-gateway/distributed-backend/quilkin_udp.go)
...
- [commands/build/compose-build/retry-summary.json](commands/build/compose-build/retry-summary.json)
- [commands/build/compose-build-attempt-1/command.json](commands/build/compose-build-attempt-1/command.json)
- [commands/build/compose-build-attempt-1/command.log](commands/build/compose-build-attempt-1/command.log)
- [commands/build/compose-build-attempt-2/command.json](commands/build/compose-build-attempt-2/command.json)
- [commands/build/compose-build-attempt-2/command.log](commands/build/compose-build-attempt-2/command.log)
- [commands/build/compose-build-attempt-3/command.json](commands/build/compose-build-attempt-3/command.json)
- [commands/build/compose-build-attempt-3/command.log](commands/build/compose-build-attempt-3/command.log)
- [commands/prepare/compose-clean/retry-summary.json](commands/prepare/compose-clean/retry-summary.json)
- [commands/prepare/compose-clean-attempt-1/command.json](commands/prepare/compose-clean-attempt-1/command.json)
- [commands/prepare/compose-clean-attempt-1/command.log](commands/prepare/compose-clean-attempt-1/command.log)
- [db/metadata.json](db/metadata.json)
