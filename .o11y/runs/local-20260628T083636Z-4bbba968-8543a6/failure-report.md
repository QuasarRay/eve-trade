...
- Run: `local-20260628T083636Z-4bbba968-8543a6`
- Environment: `local`
...
2. The command exited `1` after `34424.213 ms`.
...
- Open or build a Honeycomb query filtered by observability.run_id = local-20260628T083636Z-4bbba968-8543a6.
