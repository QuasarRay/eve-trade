...
impl TradeSettlementService for TradeSettlementGrpc {
    ...
    async fn open_trade_order(
        &self,
        request: Request<OpenTradeOrderRequest>,
    ) -> Result<Response<OpenTradeOrderResponse>, Status> {
        ...
        Ok(Response::new(
            db::open_trade_order(db::pool().map_err(Status::from)?, &request.into_inner())
                .await
                .map_err(Status::from)?,
        ))
    }
    ...
    async fn close_trade_order(
        &self,
        request: Request<CloseTradeOrderRequest>,
    ) -> Result<Response<CloseTradeOrderResponse>, Status> {
        ...
        // Why: DB boundaries must propagate success/failure explicitly.
        Ok(Response::new(
            db::close_trade_order(db::pool().map_err(Status::from)?, &request.into_inner())
                .await
                .map_err(Status::from)?,
        ))
    }
    ...
    async fn request_settlement(
        &self,
        request: Request<RequestSettlementRequest>,
    ) -> Result<Response<RequestSettlementResponse>, Status> {
        ...
        // Why: DB boundaries must propagate success/failure explicitly.
        Ok(Response::new(
            db::request_settlement(db::pool().map_err(Status::from)?, &request.into_inner())
                .await
                .map_err(Status::from)?,
        ))
    }
    ...
    async fn claim_result(
        &self,
        request: Request<ClaimResultRequest>,
    ) -> Result<Response<ClaimResultResponse>, Status> {
        ...
        // Why: DB boundaries must propagate success/failure explicitly.
        Ok(Response::new(
            db::claim_result(db::pool().map_err(Status::from)?, &request.into_inner())
                .await
                .map_err(Status::from)?,
        ))
    }
    ...
    async fn get_trade_order(
        &self,
        request: Request<GetTradeOrderRequest>,
    ) -> Result<Response<GetTradeOrderResponse>, Status> {
        ...
        // Why: DB boundaries must propagate success/failure explicitly.
        Ok(Response::new(
            db::get_trade_order(db::pool().map_err(Status::from)?, &request.into_inner())
                .await
                .map_err(Status::from)?,
        ))
    }
    ...
    async fn list_outstanding_trade_orders(
        &self,
        request: Request<ListOutstandingTradeOrdersRequest>,
    ) -> Result<Response<ListOutstandingTradeOrdersResponse>, Status> {
        ...
        // Why: DB boundaries must propagate success/failure explicitly.
        Ok(Response::new(
            db::list_outstanding_trade_orders(
                db::pool().map_err(Status::from)?,
                &request.into_inner(),
            )
            .await
            .map_err(Status::from)?,
    ...
    async fn get_transaction_state(
        &self,
        request: Request<GetTransactionStateRequest>,
    ) -> Result<Response<GetTransactionStateResponse>, Status> {
        ...
        // Why: DB boundaries must propagate success/failure explicitly.
        Ok(Response::new(
            db::get_transaction_state(db::pool().map_err(Status::from)?, &request.into_inner())
                .await
                .map_err(Status::from)?,
        ))
    }
    ...
    async fn get_settlement(
        ...
        // Why: DB boundaries must propagate success/failure explicitly.
        Ok(Response::new(
            db::get_settlement(db::pool().map_err(Status::from)?, &request.into_inner())
                .await
                .map_err(Status::from)?,
        ))
    }
    ...
    async fn get_operation(
        ...
        // Why: DB boundaries must propagate success/failure explicitly.
        Ok(Response::new(
            db::get_operation(db::pool().map_err(Status::from)?, &request.into_inner())
                .await
                .map_err(Status::from)?,
        ))
    }
