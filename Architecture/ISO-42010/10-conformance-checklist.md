...
| Environment is identified | Evidence-backed | Local and production-like environments are described. | `00-architecture-description.md`, `06-deployment-operations-view.md` | Runtime validation not run. |
...
| Evidence baseline is identified | Evidence-backed | Commit, date, validation scope, architecture file hashes, and source anchors are listed. | `18-evidence-manifest.md` | Runtime validation was not run. |
...
| Are validation results tied to dates? | Partially. Architecture doc checks are recorded in `18-evidence-manifest.md`; runtime/project checks are listed but not run in this documentation update. |
...
| Runtime validation was not run during documentation repair. | F-013, F-048, V2-015 | Validation matrix and evidence manifest record `Not run` statuses. |
