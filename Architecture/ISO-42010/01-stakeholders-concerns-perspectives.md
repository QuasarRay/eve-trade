...
- CON-08: Item and wallet ledgers must remain append-only audit trails.
...
| Deployment portability versus cloud-specific controls | CON-23, CON-27 | Compose and Kubernetes share logical topology; Terraform handles production-like AWS resources. | Some behavior depends on provider-specific networking and secrets. |
